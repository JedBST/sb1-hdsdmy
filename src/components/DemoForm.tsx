...
const DemoForm: React.FC<DemoFormProps> = ({ onClose }) => {
  const [formData, setFormData] = useState({
    ...
    demoDate: '',
    demoTime: '',
    isTeamBooking: 'individual', // Default to individual booking
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const templateParams = {
      ...
      address: formData.address, // Include address in templateParams
      companyName: formData.companyName, // Include companyName in templateParams
      isNZAdvisor: formData.isNZAdvisor ? 'Yes' : 'No',
      demoDate: formData.demoDate,
      demoTime: formData.demoTime,
      isTeamBooking: formData.isTeamBooking === 'team' ? 'Team' : 'Individual', // Include booking type
    };
